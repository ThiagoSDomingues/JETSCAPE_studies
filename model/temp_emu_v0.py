...
for ax, corr in zip(axes, VISCOUS_CORRECTIONS):
    ...
    print(pr_predictions_reshaped.shape)
...
fig.suptitle(
    "Emulator Prior Predictions — 90% Credible Intervals\n"
    "Pb–Pb 2.76 TeV",
    fontsize=15,
    fontweight="bold"
)
...
plt.savefig('prior_v0pt_60-70.pdf', dpi=300, bbox_inches='tight')
plt.show()

print("\n✓ PRIOR + EMULATOR UNCERTAINTY COMPLETE")
print("✓ Saved figure as 'prior_v0pt.pdf'")
